export let AMCtheatres = [{ id: 'amc-lennox-town-center-24', name: 'AMC Lennox' }, { id: 'amc-dublin-village-18', name: 'AMC Dublin Village' }, { id: 'amc-columbus-10', name: 'AMC Hilliard' }];
/**
 ...
 */
export function filterDataByTheatre(theatreIDs /*, startTime: Date, endTime: Date*/) {
 ...
 */
export function loadData(theatresData) {
    let showtimes = [];
    for (let theatre of AMCtheatres) {
